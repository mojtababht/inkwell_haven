"""
Django settings for inkwell_haven project.
...
SECRET_KEY = 'django-insecure-54dbcxnb4ty!698_9o*grt8=yhh^0&nh*p=7rnpz38y^#rro!p'
...
ROOT_URLCONF = 'inkwell_haven.urls'
...
WSGI_APPLICATION = 'inkwell_haven.wsgi.application'
